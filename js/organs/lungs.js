...
const PRIVATE_POOL_LUAD = [
  ...
  { gene:'RB1 loss', class:'driver', ccf:'~4% of lung adenocarcinoma, printed in the source as a mutation frequency rather than a deletion or total-inactivation one (TCGA, Nature, 2014) — the same counting rule that makes the CDKN2A entry above carry a quotation instead of a number', note:'Removes a cell-cycle checkpoint — a common co-occurring event alongside KRAS rather than an alternative driver, adding proliferative pressure without touching RAS/MAPK or PI3K signaling at all.' },
