...
const REGIONS_HCC = [
  ...
  { id:'LN', name:'Lymph nodes', color:cssVar('--amber'), pos3d:{x:1.2,y:0.5,z:-0.4},
    branch:{ gene:'TP53 mutation', class:'driver', ccf:'20.8% of HCC (Guichard et al., Nature Genetics, 2012)', note:'The same chromosomally-unstable branch gene as the Lung site above — real lymph node involvement is one of the three most common sites of extrahepatic HCC spread (41%, Katyal et al., Radiology, 2000), though unlike Lung and Bone no independent, more recent population-based study was found here to corroborate or revise it — the largest recent SEER analysis located (Zhuang et al., 2025) excludes patients with lymph-node metastasis by design, so it cannot speak to this figure either way.' } },
