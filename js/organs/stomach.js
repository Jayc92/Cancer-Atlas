...
const PRIVATE_POOL_GDIFF = [
  ...
  { gene:'APC mutation', class:'driver', ccf:'among TCGA\'s 25 significantly mutated gastric-cancer genes (β-catenin pathway; TCGA, Nature, 2014) — no clean subtype-specific percentage was found to cite here, so none is shown', note:'The colon\'s famous gatekeeper is a real, recurrently mutated gastric gene too — a reminder that the same genes recur across the GI tract at different ranks. No conflict with CDH1, RHOA, or the CLDN18–ARHGAP fusion was found in the cited TCGA analysis.' },
  { gene:'SMAD4 mutation', class:'driver', ccf:'among TCGA\'s 25 significantly mutated gastric-cancer genes (TGF-β pathway; TCGA, Nature, 2014) — no clean subtype-specific percentage was found to cite here, so none is shown', note:'The TGF-β pathway\'s central mediator, of pancreatic-cancer fame, recurrently lost here as well — breaking growth-inhibitory signaling in a tumor whose defining lesion is adhesive, not proliferative: cooperation, not redundancy.' },
