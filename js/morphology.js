...
export const EXTENT_STATUS = Object.freeze({
  ...
  ptc: { status: 'cited', site: 'thyroid', siteNote: 'thyroid cancer as a whole, not papillary carcinoma alone — checked directly against Aschebrook-Kilfoy et al. (below) and confirmed negligibly different (63.3/31.5/3.5/1.7), the arithmetic-dominance case for an ~84%-share subtype', shares: { localized: 63, regional: 31, distant: 3, unknown: 3 }, modal: 'localized', basis: 'SEER 21 (Excluding IL) 2016–2022, SEER Combined Summary Stage', submission: 'not stated on the page', source: 'SEER Cancer Stat Facts: Thyroid Cancer', ref: 'https://seer.cancer.gov/statfacts/html/thyro.html — verified 2026-09-10; cross-checked against Aschebrook-Kilfoy et al. 2011 (PMID 21186939) 2026-09-12' },
  ftc: { status: 'cited', site: 'follicular thyroid carcinoma', siteNote: 'follicular thyroid carcinoma — the entry itself; ptc stays on the shared aggregate above, confirmed negligibly different for that dominant subtype', shares: { localized: 53, regional: 37, distant: 6, unknown: 3 }, modal: 'localized', basis: 'Aschebrook-Kilfoy et al., Thyroid, 2011, Table 3 — SEER 13, non-Hispanic white patients, 1992–2006, follicular-histotype-confirmed (N=3,129 of 1,672/1,173/195/89); distant share nearly doubles versus the shared aggregate (6.2% vs 3%), though localized stays modal rather than flipping; corroborated directionally on the distant-rate direction by Oyer et al., Ann Otol Rhinol Laryngol, 2014 (PMID 24574464), though that paper\'s own regional-metastasis figure runs the other way and could not be reconciled from its paywalled full text', source: 'Aschebrook-Kilfoy et al., Thyroid, 2011', ref: 'PMID 21186939, PMCID PMC3025182 — verified 2026-09-12 (live fetch of Table 3, not hand-copied)' },
