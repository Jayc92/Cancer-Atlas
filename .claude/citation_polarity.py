...
# 2026-09-09 ran it from /tmp and it produced no DONE line (the record paths it opens are repo-relative). Relative paths stay the record identities; their resolution no
