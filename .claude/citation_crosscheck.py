...
DECLARED = [
    ...
    {'key': '25229645|Carunchio|2015', 'reason': 'cervix.js:143: the source correctly writes the full compound surname "Rodríguez-Carunchio" (matching the id\'s own first author, Rodriguez-Carunchio L); this tool\'s own extraction truncated it to the second component — same truncation artifact as the marrow.js Chaparro/Segura and uterus.js Castillo entries.', 'until': None},
    {'key': '28112728|TCGA|2017', 'reason': 'cervix.js:172: PMID 28112728 is TCGA\'s "Integrated genomic and molecular characterization of cervical cancer" paper; PubMed\'s own first-author field for this consortium paper is the corporate group name itself ("Cancer Genome Atlas Research Network"), while the atlas correctly names the paper by its own consortium acronym — same consortium-name convention as the uterus.js Kandoth entry above.', 'until': None},
