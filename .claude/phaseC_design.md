...
3. **Keep a running registry, here, of every origin-axis entry whose honest answer is not
   ...
   | acute myeloid leukemia (`aml`, AUTHORED 2026-09-15) | marrow | origin is a founder-genotype (NPM1-cooperating vs. TP53-competing) and blast-differentiation stage, not a location — this organ's entire cancer list shares this shape, since blood cancers arise along a branching developmental lineage rather than at a site | Papaemmanuil et al., *N Engl J Med*, 2016, PMID 27276561; Khoury et al., *Leukemia*, 2022, PMID 35732831 |
   | acute promyelocytic leukemia (`apl`, AUTHORED 2026-09-15) | marrow | origin is the PML-RARA fusion event and the resulting promyelocytic differentiation block — a genetic/developmental fact, not a site | Cingam & Koshy, StatPearls, NCBI Bookshelf NBK459352 |
   | chronic myeloid leukemia (`cml`, AUTHORED 2026-09-15) | marrow | origin is the BCR-ABL1 founder event within a myeloid stem/progenitor cell — a genetic/developmental fact; this organ's own stem-cell-niche question (endosteal/perivascular/splenic) is a SEPARATE, disclosed-as-multi-compartment finding, not routed through this mechanism | Ren, *Nat Rev Cancer*, 2005, PMID 15719031 |
   | myelodysplastic neoplasm (`mds`, AUTHORED 2026-09-15) | marrow | origin is a founder-genotype (multi-hit TP53 vs. SF3B1/spliceosome) within a myeloid progenitor, not a location | Khoury et al., 2022, PMID 35732831; Bernard et al., *Nat Med*, 2020, PMID 32747829 |
   | essential thrombocythemia (`et`, AUTHORED 2026-09-15) | marrow | origin is which of JAK2/CALR/MPL activates the megakaryocyte lineage — a genetic/developmental fact | Vainchenker & Kralovics, *Blood*, 2017, PMID 28028029 |
   | polycythemia vera (`pv`, AUTHORED 2026-09-15) | marrow | origin is JAK2 activation of the erythroid lineage specifically — mechanistically restricted to JAK2 because CALR/MPL cannot activate the erythropoietin receptor | Vainchenker & Kralovics, 2017, PMID 28028029 |
   | primary myelofibrosis (`pmf`, AUTHORED 2026-09-15) | marrow | same JAK2/CALR/MPL founder-genotype question as `et`, within the megakaryocyte lineage | Vainchenker & Kralovics, 2017, PMID 28028029 |
   | multiple myeloma (`mm`, AUTHORED 2026-09-15) | marrow | origin is the terminal, antibody-secreting endpoint of the B-cell lineage — "a post-germinal center plasma cell" — a developmental fact, not a site | StatPearls, NCBI Bookshelf NBK534764 |
   | chronic lymphocytic leukemia / SLL (`cll`, AUTHORED 2026-09-15) | marrow | IGHV mutation status reflects whether the founding B cell transited the germinal center before transformation — a lineage fact, not a driver mutation or a site, the same shape as this file's own `ndlbcl` row | Kipps et al., *Nat Rev Dis Primers*, 2017, PMID 28102226 |
   | acute lymphoblastic leukemia (`all`, AUTHORED 2026-09-15) | marrow | origin is B- vs. T-lymphoblastic lineage — which lymphoid lineage the leukemic transformation arrested within — a developmental, not oncogenic, fact | Iacobucci & Mullighan, *J Clin Oncol*, 2017, PMID 28297628 |
